...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
	...
	Route::post('/get-collection', 'CollectionController@collectionData')->name('get-collection');
	...
	/// KHANSA CODE
	Route::get('uploadProductsToShopify/{productId}', 'ShopifyProductController@uploadProductsToShopify')->name('uploadProductsToShopify');
	Route::get('postproduct', 'ShopifyProductController@postproduct')->name('postproduct');
	Route::get('updateProduct', 'ShopifyProductController@updateProduct')->name('updateProduct');
	/// KHANSA CODE
	...
	Route::get('report/available-stock', 'ReportController@availableStock')->name('report.availableStock');
	...
	Route::get('report/daily_sale', 'ReportController@dailySaleNew');
	...
	Route::post('report/profit_loss_new', 'ReportController@profitLossNew')->name('report.profitLossNew');
	...
	Route::post('report/sale_report', 'ReportController@saleReportNew')->name('report.sale');
	Route::post('report/sale_report_cat', 'ReportController@saleReportCat')->name('report.sale-cat');

	//hr report
	Route::post('report/tax_report', 'ReportController@taxReport')->name('report.tax-report');
	Route::post('report/purchase_tax_report', 'ReportController@purchaseTaxReport')->name('report.purchase-tax-report');
	//hr report end
	...
	Route::post('report/customer_report_new', 'ReportController@customerReportNew')->name('report.customerNew');
	...
	Route::post('report/customer-credit-report', 'ReportController@customerCreditReportByDate')->name('report.customerCreditByDate');
	Route::post('report/all-customer-credit-report', 'ReportController@customerCreditReportByDateAll')->name('report.customerCreditByDateAll');
	...
	Route::post('product_upload_img', 'ProductController@uploadProductImg')->name('product_upload_img');
	Route::get('product_delete_img/{id}', 'ProductController@deleteProductImg')->name('product_delete_img');
	Route::post('product_upload_variant', 'ProductController@uploadProductVariant')->name('product_upload_variant');
	Route::post('product_update_variant/{id}', 'ProductController@updateProductVariant')->name('product_update_variant');
	Route::get('product_delete_variant/{id}', 'ProductController@deleteProductVariant')->name('product_delete_variant');
