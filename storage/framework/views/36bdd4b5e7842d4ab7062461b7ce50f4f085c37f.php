                            ...
                            <div class="table-responsive ml-2">
                                <table id="variant-table" class="table table-hover variant-list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="variant_title[]" class="form-control" value="<?php echo e($eachVariant->title); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="text" name="variant_description[]" class="form-control" value="<?php echo e($eachVariant->item_code); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" name="variant_price[]" class="form-control" value="<?php echo e($eachVariant->price); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" name="variant_additional_cost[]" class="form-control" value="<?php echo e($eachVariant->additional_cost); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" name="variant_qty[]" class="form-control" value="<?php echo e($eachVariant->qty); ?>" disabled>
                                            </td>
                                            <td class="d-flex">
