                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="card shadow-lg  p-3 bg-white rounded col-md-12">
                                    ...
                                    <div class="d-flex justify-content-start" id="database_images" style="border: 2px dashed;margin-top: 10px;">
                                        ...
                                        <img src="<?php echo e(asset('images/product/' . $url)); ?>" alt="Product Image" class="mr-2 mt-1 mb-1 ml-2" style="width: 100px; height: 150px; border:1px solid;">
                                        <?php else: ?>
                                        <img src="<?php echo e($url); ?>" alt="Product Image" class="mr-2 mt-1 mb-1 ml-2" style="width: 100px; height: 150px;">
                                        <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="barcode_symbology" required class="form-control selectpicker">
                                                <option value="<?php echo e($lims_product_data->barcode_symbology); ?>" selected><?php echo e($lims_product_data->barcode_symbology); ?></option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="dbRows">
                                            ...
                                            <td class="variant-name mt-2"><?php echo e($eachVariant->title); ?>
                                                ...
                                                <input type="hidden" name="variant_name[]" value="<?php echo e($eachVariant->title); ?>"  /></td>
                                            <td>
                                                <input type="text" name="item_code[]" class="form-control" value="<?php echo e($eachVariant->item_code); ?>" >
                                            </td>
                                            <td>
                                                <input type="number" name="additional_price[]" class="form-control" value="<?php echo e($eachVariant->price); ?>" >
                                            </td>
                                            <td>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-select border w-100" name="save_status" title="Select Status">
                                        <option value="<?php echo e($lims_product_data->status); ?>" selected><?php echo e($lims_product_data->status); ?></option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                        <option value="<?php echo e($lims_product_data->category->id); ?>" selected><?php echo e($lims_product_data->category->name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select border w-100" aria-label="Default select example" title="Select Product type" name="prod_type" value="<?php echo e(old('prod_type')); ?>" style="border: 1px solid black; border-radius: 5px;">
                                    <option value="<?php echo e($lims_product_data->product_type); ?>" selected><?php echo e($lims_product_data->product_type); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                        <option value="<?php echo e($lims_product_data->brand->id); ?>" selected><?php echo e($lims_product_data->brand->title); ?></option>
            ...
            this.each(function() {
                ...
                for (i = 0; i < combinations.length; i++) {
                    ...
                    cols += '<td class="variant-name mt-2">' + variant_name +
                        '<input type="hidden" name="variant_name[]" value="' + variant_name + '"  /></td>';
                    cols +=
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PFL\pfl\resources\views/backend/product/edit.blade.php ENDPATH**/ ?>