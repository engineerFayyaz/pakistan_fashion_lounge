...
<html dir="<?php if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl): ?><?php echo e('rtl'); ?><?php endif; ?>">
  <head>
    ...
    <title>Pakistan Fashion Longue</title>
  ...
  <body class="<?php if($theme == 'dark'): ?>dark-mode dripicons-brightness-low <?php endif; ?>  <?php if(Route::current()->getName() == 'sale.pos'): ?> pos-page <?php endif; ?>" onload="myFunction()">
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        <span class="brand-big">
            <?php if(isset($general_setting->site_logo) && $general_setting->site_logo != ''): ?>
              <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/images/'.$general_setting->site_logo)); ?>" width="100"></a>
            <?php else: ?>
    ...
    <div class="page">
      ...
      <div id="customer-modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">Customer Credit</h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'report.customerNew', 'method' => 'post']); ?>
    ...
    <script type="text/javascript">
      ...
      $("a#customer-report-link-credit").click(function(e){
        e.preventDefault();
        $('#customer-modal2').modal();
      });
...
<?php /**PATH D:\5TechSol\Projects\PFL\pakistan_fashion_lounge\pakistan_fashion_lounge\resources\views/backend/layout/main.blade.php ENDPATH**/ ?>