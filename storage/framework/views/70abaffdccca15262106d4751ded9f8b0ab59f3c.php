        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li>
                <a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
            ...
            ?>
            <li><a href="<?php echo e(route('collection')); ?>"> <i class="dripicons-archive"></i><span>Collections</span></a></li>
            <?php if($index_permission_active): ?>
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                <li id="availableStock-report-menu">
                <a href="/report/available-stock">Available Stock</a>
               
                </li>
                <?php endif; ?>
                <?php if($customer_report_active): ?>
                <li id="customer-report-menu">
                <a id="customer-report-link-credit" href="">Customer Credit Report</a>
                </li>
                <?php endif; ?>
                <?php if($due_report_active): ?>
                <!-- <li id="credit-report-menu">
                    
                    <form action="/report/customer-credit-report" method="post" id="customer-credit-report-form">
                        <?php echo csrf_field(); ?> 
                        ...
                        <a id="credit-report-link" href="javascript:{}" onclick="document.getElementById('customer-credit-report-form').submit();">Customer Credit Report</a>
                    </form>
                </li> -->
                <li id="c-credit-report-menu">
                    
                    <form action="/report/all-customer-credit-report" method="post" id="c-customer-credit-report-form">
                        <?php echo csrf_field(); ?> 
                        <input type="hidden" name="start_date" value="<?php echo e(date('Y-m-d', strtotime('-1 year'))); ?>" />
                         <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                        <a id="c-credit-report-link" href="javascript:{}" onclick="document.getElementById('c-customer-credit-report-form').submit();">All Customer Credit Report</a>
                    </form>
                </li>
                <?php endif; ?>
                <?php if($daily_sale_active): ?>
                <li id="daily-sale-report-menu">
                <a href="<?php echo e(url('report/daily_sale/')); ?>">Daily Sales</a>
                ...
                <a id="sale-report-link" href="">Sales report</a>
                <?php echo Form::close(); ?>

                </li>
                <?php endif; ?>
                <?php if($profit_loss_active): ?>
                <li id="new-profit-loss-report-menu">
                 <form action="<?php echo e(url('report/profit_loss_new/')); ?>" method="post" id="newprofitLoss-report-form">
                    <?php echo csrf_field(); ?> 
                    <input type="hidden" name="start_date" value="<?php echo e(date('Y-m').'-'.'01'); ?>" />
                <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                <a id="newprofitLoss-link"href="javascript:{}" onclick="document.getElementById('newprofitLoss-report-form').submit();">Profit And Loss</a>
                 </form>
                ...
                <?php endif; ?>
                <?php if($sale_report_active): ?>
                <li id="cat-sale-report-menu">
                <?php echo Form::open(['route' => 'report.sale-cat', 'method' => 'post', 'id' => 'cat-sale-report-form']); ?>

                <input type="hidden" name="start_date" />
                <input type="hidden" name="end_date" />
                <input type="hidden" name="biller_id" value="" />
                <a id="cat-sale-report-link" href="javascript:{}" onclick="document.getElementById('cat-sale-report-form').submit();">Sales By Category</a>
                <?php echo Form::close(); ?>
                ...
                <input type="hidden" name="end_date" />
                <input type="hidden" name="biller_id" value="" />
                <a id="cat-sale-report-link" href="javascript:{}" onclick="document.getElementById('tax-report-form').submit();">Tax Report</a>
                <?php echo Form::close(); ?>

                </li>
                <!--- ending tax report by hr --->
            ...
            <li><a href="#addons" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-flag"></i><span><?php echo e(trans('file.Addons')); ?></span></a>
                <ul id="addons" class="collapse list-unstyled">
                    <li id="addon-list"><a href="<?php echo e(url('addon-list')); ?>"> <span><?php echo e(trans('file.Addon List')); ?></span></a></li>
                    <?php if(\Schema::hasColumn('products', 'woocommerce_product_id')): ?>
                        <li><a href="<?php echo e(route('woocommerce.index')); ?>"> <span>WooCommerce</span></a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <?php endif; ?> -->
            ...
            <?php endif; ?> -->
        </ul><?php /**PATH F:\BHAI LOG\More Projects\reports making\pakistan_fashion_lounge\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>