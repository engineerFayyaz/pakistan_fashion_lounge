                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" value="<?php echo e($lims_product_data->name); ?>" id="name" aria-describedby="name" required>
                                                ...
                                                <?php $__currentLoopData = $lims_product_data->product_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if($isShopifyUrl === false): ?>
                                                        <div class="product-img-container mr-2 mt-1 mb-1 ml-2">
                                                            <img src="<?php echo e(asset('images/product/' . $url)); ?>" alt="Product Image" style="width: 100%; height: 100%; object-fit: container;">
                                                            <button class="btn delete-btn" data-type="back" data-imgId="<?php echo e($image['id']); ?>">
                                                                <i class="fas fa-trash"></i>
                                                            </button>
                                                        </div>
                                                        <?php else: ?>
                                                        <div class="product-img-container mr-2 mt-1 mb-1 ml-2">
                                                            <img src="<?php echo e($url); ?>" alt="Product Image" style="width: 100%; height: 100%; object-fit: container;">
                                                            <button class="btn delete-btn" data-type="back" data-imgId="<?php echo e($image['id']); ?>">
                                                                <i class="fas fa-trash"></i>
                                                            </button>
                                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" value="<?php echo e($lims_product_data->code); ?>" id="code" aria-describedby="code" required>
                                        ...
                                        <div class="input-group">
                                            <select name="barcode_symbology" required class="form-control selectpicker">
                                                <option value="<?php echo e($lims_product_data->barcode_symbology); ?>" selected>
                                                    <?php echo e($lims_product_data->barcode_symbology); ?>
                                ...
                                <!-- <div class="col-md-12 mt-3" id="batch-option" style="display: <?php echo e(count($lims_product_data->productVariants) > 0 ? 'none' : 'block'); ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price">
                                            ...
                                            <input type="number" name="promotion_price" class="form-control" value="<?php echo e($lims_product_data->promotion_price); ?>" step="any" />
                    ...
                    <div class="card shadow-lg  p-3 bg-white cards">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control price" name="price" value="<?php echo e($lims_product_data->price); ?>" id="fields" placeholder="Enter amount" aria-label="Amount" oninput="getValue()" style="border: 1px solid black; border-radius: 5px;">
                                <div class="error-message text-danger" id="price-error"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4" class="title">Compare-at-price</label>
                                <input type="text" class="form-control comp_price" name="comp_price" value="<?php echo e($lims_product_data->comp_price ?? old('comp_price')); ?>" id="fields" placeholder="Enter amount" oninput="getValue()" aria-label="Amount" style="border: 1px solid black; border-radius: 5px;">
                    ...
                    <!-- <div class="card shadow-lg p-3 bg-white cards">
                        ...
                        <div class=" form-group col-md-4" id="shipping_field">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="number" class="form-control" value="<?php echo e($lims_product_data->productVariants[0]->weight); ?>" id="currencyInput" name="weight" aria-label="Amount" step="0.01" style="border: 1px solid black; border-radius: 5px;">
                                <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <select required class="form-control selectpicker" name="unit_id">
                                    ...
                                    <option value="<?php echo e($lims_product_data->productVariants[0]->weight_unit); ?>" selected><?php echo e($lims_product_data->productVariants[0]->weight_unit); ?></option>
                                    <?php else: ?>
                                    <option></option>
                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card shadow-lg p-3 bg-white cards">
                        <div class="col-md-12 mt-3" id="variant-option">
                            <h5>
                                <input name="is_variant" type="checkbox" id="is-variant" value="1" <?php echo e(count($lims_product_data->productVariants) > 0 ? 'checked' : ''); ?>>&nbsp;
                        ...
                        <div class="col-md-12" id="variant-section">
                                    ...
                                    <div class="col-12 d-flex py-1 justify-content-between">
                                        <div class="d-flex flex-column justify-content-start">
                                            ...
                                            <div class="tag-container d-flex">
                                                <?php $__currentLoopData = $sizeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="py-1 px-3 d-inline badge badge-pill badge-light m-2 ml-0"><?php echo e($size); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-column justify-content-start">
                                            ...
                                            <div class="tag-container d-flex">
                                                <?php $__currentLoopData = $colorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="py-1 px-3 d-inline badge badge-pill badge-light m-2 ml-0"><?php echo e($color); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-column justify-content-start">
                                            ...
                                            <div class="tag-container d-flex">
                                                <?php $__currentLoopData = $materialList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="py-1 px-3 d-inline badge badge-pill badge-light m-2 ml-0"><?php echo e($material); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group px-0">
                                <a class="btn btn-link add-more-variant">
                                    <i class="dripicons-plus"></i><?php echo e(trans('file.Add More Variant')); ?>
                            ...
                            <div class="table-responsive position-relative">
                                <table id="variant-table" class="table table-hover variant-list">
                                    ...
                                    <tbody>
                                        ...
                                        -->
                                        <tr class="dbRows" data-varId="<?php echo e($eachVariant->id); ?>">
                                            <td class="variant-name mt-2">
                                                <?php echo e($eachVariant->title); ?>

                                                <input type="hidden" name="variant_name[]" value="<?php echo e($eachVariant->title); ?>" />
                                            </td>
                                            <!-- <td>
                                                <input type="text" name="item_code[]" class="form-control" value="<?php echo e($eachVariant->item_code); ?>">
                                            </td> -->
                                            <td>
                                                <input type="text" name="additional_price[]" class="form-control comp_price" id="fields" value="<?php echo e($eachVariant->price); ?>" placeholder="Enter amount" aria-label="Amount">
                                            </td>
                                            <!-- <td>
                                                <input type="number" name="additional_cost[]" class="form-control" value="<?php echo e($eachVariant->additional_cost); ?>">
                                            </td> -->
                                            <td>
                                                <input type="number" name="variant_quantity[]" class="form-control" value="<?php echo e($eachVariant->qty); ?>">
                                            </td>
                                            <td class="d-flex">
                                                <!-- 
                                ...
                                <div>
                                    <select class="form-select border w-100" name="save_status" title="Select Status">
                                        <option value="<?php echo e($lims_product_data->status); ?>" selected>
                                            <?php echo e($lims_product_data->status); ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" id="start_date" name="startdate" class="date-picker form-control" value="<?php echo e($lims_product_data->starting_date); ?>" />
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" id="end_date" name="enddate" class="date-picker form-control" value="<?php echo e($lims_product_data->last_date); ?>" />
                                        </div>
                                ...
                                <div class="input-group">
                                    <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                        <option value="<?php echo e($lims_product_data->category->id); ?>" selected>
                                            <?php echo e($lims_product_data->category->name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select border w-100" aria-label="Default select example" title="Select Product type" name="prod_type" value="<?php echo e(old('prod_type')); ?>" style="border: 1px solid black; border-radius: 5px;">
                                    <option value="<?php echo e($lims_product_data->product_type); ?>" selected>
                                        <?php echo e($lims_product_data->product_type); ?>
                                ...
                                <div class="input-group">
                                    <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                        <option value="<?php echo e($lims_product_data->brand->id ?? ''); ?>" selected>
                                            <?php echo e($lims_product_data->brand->title ?? ' '); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <div class="user_database_tags">
                                        ...
                                        <input type="hidden" class="user_database_tags" name="user_database_tags[]" value="<?php echo e($tag); ?>">
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<script>
    ...
    function preview() {
        ...
        let imageFiles = [];
        formData.append('prodId','<?php echo e($lims_product_data->id); ?>');
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("product_upload_img")); ?>',
            data: formData,
            contentType: false,
            processData: false,
            beforeSend: function() {
                ...
                if(response.result){
                    ...
                    imgList.forEach(element => {
                        ...
                        if(element.src.startsWith("https://cdn.shopify.com/")){
                            ...
                            url = `<?php echo e(asset('images/product/${element.src}')); ?>`;
                        }
    ...
    $(document).on('click','.product-img-container .delete-btn',function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = '<?php echo e(route("product_delete_img",":id")); ?>';
...
<script type="text/javascript">
    ...
    let sizeValues = '<?php echo e(implode(",",$sizeList)); ?>';
    let colorValues = '<?php echo e(implode(",",$colorList)); ?>';
    let materialValues = '<?php echo e(implode(",",$materialList)); ?>';
    ...
    $(document).on('click','.done-variant',function(){
        ...
        $.ajax({
            url: '<?php echo e(route("product_upload_variant")); ?>',
            method: 'POST',
            contentType: "application/json",
            data: JSON.stringify(
                {
                    productId: "<?php echo e($lims_product_data->id); ?>",
                    type: parent.val(),
    ...
    $(document).on('click','.delete-variant',function(event){
        ...
        console.log(id);
        let url = '<?php echo e(route("product_delete_variant",":id")); ?>';
        url = url.replace(":id",id);
        $.ajax({
            url: url,
            method: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development-Software\IDE\wamp64\www\pakistan_fashion_lounge\resources\views/backend/product/edit.blade.php ENDPATH**/ ?>