              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number sales-data"><?php echo e($sales); ?></div>
                        <div class="name"><strong style="color: #733686">Total Sales</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-4">
                  <div class="wrapper count-title">
                    <div class="icon"><i class="dripicons-user-group" style="color: #d79330"></i></div>
                    <div>
                        <div class="count-number customers-data"><?php echo e($customers); ?></div>
                        <div class="name"><strong style="color: #d79330">Total Customers</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-4">
                  <div class="wrapper count-title">
                    <div class="icon"><i class="dripicons-view-apps" style="color: #D2DE32"></i></div>
                    <div>
                        <div class="count-number inventory-data"><?php echo e($inventory); ?></div>
                        <div class="name"><strong style="color: #D2DE32">Total Inventory</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    <div class="icon"><i class="dripicons-graph-line" style="color: #E55604"></i></div>
                    <div>
                        <div class="count-number revenue-data"><?php echo e(number_format((float)$revenue,$general_setting->decimal, '.', '')); ?> €</div>
                        <div class="name"><strong style="color: #E55604">Revenue</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\5TechSol\Projects\PFL\pakistan_fashion_lounge\pakistan_fashion_lounge\resources\views/backend/index.blade.php ENDPATH**/ ?>