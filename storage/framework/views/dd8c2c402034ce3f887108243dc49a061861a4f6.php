    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h4 class="text-center"><?php echo e(trans('file.Customer Due Report')); ?></h4>
            </div>
            <?php echo Form::open(['route' => 'report.customerDueByDate', 'method' => 'post']); ?>
    ...
    <div class="table-responsive mb-4">
        <table id="report-table" class="table table-hover" style="width:100%">
            ...
            <tfoot class="tfoot active">
                ...
                <th></th>
                <th></th>
                <th><?php echo e(number_format(0, $general_setting->decimal, '.', '')); ?></th>
                <th><?php echo e(number_format(0, $general_setting->decimal, '.', '')); ?></th>
                <th><?php echo e(number_format(0, $general_setting->decimal, '.', '')); ?></th>
                <th><?php echo e(number_format(0, $general_setting->decimal, '.', '')); ?></th>
            </tfoot>
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\5TechSol\Projects\PFL\pakistan_fashion_lounge\pakistan_fashion_lounge\resources\views/backend/report/due_report.blade.php ENDPATH**/ ?>