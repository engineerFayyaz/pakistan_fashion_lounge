        ...
        $.get('stock-count/stockdif/' + stock_count[8], function(data){
            ...
            if(name_code){
                ...
                $.each(name_code, function(index){
                    ...
                    cols += '<td>' + parseFloat(expected[index]).toFixed(<?php echo e($general_setting->decimal); ?>) + '</td>';
                    cols += '<td>' + parseFloat(counted[index]).toFixed(<?php echo e($general_setting->decimal); ?>) + '</td>';
                    cols += '<td>' + parseFloat(dif[index]).toFixed(<?php echo e($general_setting->decimal); ?>) + '</td>';
                    cols += '<td>' + parseFloat(cost[index]).toFixed(<?php echo e($general_setting->decimal); ?>) + '</td>';
                    newRow.append(cols);
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PFL\pfl\resources\views/backend/stock_count/index.blade.php ENDPATH**/ ?>