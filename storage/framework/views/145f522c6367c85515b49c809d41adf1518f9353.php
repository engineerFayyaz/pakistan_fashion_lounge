            ...
            <div class="card-body">
				<div class="col-md-12">
					<div class="col-md-6 offset-md-3 mt-3 text-center">
						<?php echo e(Form::open(['route' => 'report.warehouseStock', 'method' => 'get', 'id' => 'report-form'])); ?>
					...
					<div class="col-md-6 offset-md-3 mt-3 mb-3">
						<div class="row">
							<div class="col-md-6">
								...
								<h2><strong><?php echo e(number_format((float)$total_item, $general_setting->decimal, '.', '')); ?></strong></h2>
							</div>
							<div class="col-md-6">
								<span>Total <?php echo e(trans('file.Quantity')); ?></span>
								<h2><strong><?php echo e(number_format((float)$total_qty, $general_setting->decimal, '.', '')); ?></strong></h2>
							</div>
						</div>
					</div>
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\5TechSol\Projects\PFL\pakistan_fashion_lounge\pakistan_fashion_lounge\resources\views/backend/report/warehouse_stock.blade.php ENDPATH**/ ?>