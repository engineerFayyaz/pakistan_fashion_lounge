...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        ...
        $('#exchange_rate').val($('#currency option').eq(0).data('rate'));
        $('#exchange_rate').attr('value',$('#currency option').eq(0).data('rate'));
                ...
                $.each(data['name'], function(index) {
                    ...
                    if (index % 5 == 0 && index != 0)
                        tableData += `
                            ...
                            <tr>
                                <td class="product-img sound-btn" title="${data['name'][index]}" data-product = "${product_info}">
                                    <img  src="${data['src'][index]}" width="100%"/>
                                    <p>${data['name'][index]}</p>
                                    <span>${data['code'][index]}</span>
                                    <span>${data['var_id'][index]}</span>
                                </td>`;
                    else
                        tableData += `
                            <td class="product-img sound-btn" title="${data['name'][index]}" data-product = "${product_info}">
        ...
        $(".payment-btn").on("click", function() {
            var audio = $("#mysoundclip2")[0];
            audio.play();
            $('input[name="paid_amount"]').val($("#grand-total").text().split(' €')[0]);
            $('input[name="paying_amount"]').val($("#grand-total").text().split(' €')[0]);
            $('.qc').data('initial', 1);
        });
        ...
        $('input[name="paid_amount"]').on("input", function() {
            ...
            else if ($(this).val() > parseFloat($('#grand-total').split(' €')[0].text())) {
...
<?php echo $__env->make('backend.layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development-Software\IDE\wamp64\www\pakistan_fashion_lounge\resources\views/backend/sale/pos.blade.php ENDPATH**/ ?>