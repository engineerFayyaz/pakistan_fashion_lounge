        ...
        <table id="payroll-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($payroll->id); ?>">
                    ...
                    <td><?php echo e(number_format((float)$payroll->amount, $general_setting->decimal, '.', '')); ?></td>
              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="created_at" class="form-control date" placeholder="Choose date" value="<?php echo e(date('d-m-Y')); ?>" />
                    </div>
                    <div class="col-md-6 form-group">
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PFL\pfl\resources\views/backend/payroll/index.blade.php ENDPATH**/ ?>