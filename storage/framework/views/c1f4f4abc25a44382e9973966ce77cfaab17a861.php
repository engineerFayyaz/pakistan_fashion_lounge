        ...
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(number_format((float)$credit[$key], $general_setting->decimal, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)($debit[$key] * -1), $general_setting->decimal, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)($credit[$key] - $debit[$key]), $general_setting->decimal, '.', '')); ?></td>
                </tr>
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PFL\pfl\resources\views/backend/account/balance_sheet.blade.php ENDPATH**/ ?>