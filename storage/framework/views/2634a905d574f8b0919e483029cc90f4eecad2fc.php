                                    ...
                                    <div class="card shadow-lg  p-3 bg-white rounded col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="media_style">
                                                <input type="file" id="file-input" name="pro_image[]"
                        ...
                        <div class="card shadow-lg  p-3 bg-white cards">
                            ...
                            <div class="custom-control custom-checkbox mb-3">
                                <input type="checkbox" class="custom-control-input" id="taxCharge"
                                    onclick="toggleTax()">
                                <label class="custom-control-label taxChange" id="taxId" style="margin-top: 1px;"
                                    oninput="getValue()" for="taxCharge">Change Tax on this
                                    product</label>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card shadow-lg  p-3  bg-white cards">
                            ...
                            <div class="custom-control custom-checkbox mb-3 mt-3">
                                ...
                                <label class="custom-control-label track " style="margin-top: 1px;" for="customCheck1"
                                    id="toggleQuantityCheck">Track Quantity</label>
                            </div>
                            <div id="toggle_quantity" style="display: none;">
                                ...
                                <div class="custom-control custom-checkbox mb-1 mt-2">
                                    <input type="checkbox" class="custom-control-input" onclick="toggleStockField()"
                                        id="customCheck2">
                                    <label class="custom-control-label contSelling" for="customCheck2"
                                        style="margin-top: 1px;">Continue Selling When Out Of Stock</label>
                        ...
                        <div class="card shadow-lg p-3 bg-white cards">
                            ...
                            <div class="custom-control custom-checkbox mb-3 mt-2">
                                <input type="checkbox" class="custom-control-input" id="shipping"
                                    onclick="toggleShippingField()">
                                <label class="custom-control-label" for="shipping" id="req_shipping"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="#" style="margin-top: -1px;;" class="text">Manage<i
                                                class="fas fa-chevron-down down-arrow"></i></a>
                                    </div>
                                    <!-- <ul > -->
                                    <div>
                        ...
                        <div class="card shadow-sm p-3 bg-white cards">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control tags" id="search_tags"
                                            placeholder="Search Tags" name="user_selected_tags"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        ...
                                        <input type="hidden" class="form-control tags" name="tags[]"
                                            id="tag_collection" placeholder="Search Tags"
                                            style="border: 1px solid black; border-radius: 5px;">
                        ...
                        <div class="card shadow-sm p-3 bg-white cards">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="form-select border w-100" name="pro_theme"
