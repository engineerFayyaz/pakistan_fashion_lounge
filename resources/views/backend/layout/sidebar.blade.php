        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li>
                <a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.product')}}</span><span></a>
            ...
            ?>
            <li><a href="{{route('collection')}}"> <i class="dripicons-archive"></i><span>Collections</span></a></li>
            @if($index_permission_active)
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                <a href="{{url('report/daily_sale/')}}">Daily Sales</a>
                ...
                <li id="new-profit-loss-report-menu">
                 <form action="{{url('report/profit_loss_new/')}}" method="post" id="newprofitLoss-report-form">
                    @csrf 
                ...
                {!! Form::open(['route' => 'report.sale-cat', 'method' => 'post', 'id' => 'cat-sale-report-form']) !!}
                <input type="hidden" name="start_date" />
                <input type="hidden" name="end_date" />
                <input type="hidden" name="biller_id" value="" />
            ...
            <li><a href="#addons" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-flag"></i><span>{{trans('file.Addons')}}</span></a>
