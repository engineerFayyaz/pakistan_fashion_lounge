                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.You can upload multiple images. Only .jpeg, .jpg, .png, .gif files can be uploaded. The first image will be the base image.')}}"></i>
