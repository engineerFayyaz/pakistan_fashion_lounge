...
<script>
    ...
    function productDetails(productArray, imagedata) {
        ...
        htmltext = '<p><strong>{{trans("file.Type")}}: </strong>' + productArray[0].trim() + '</p><p><strong>{{trans("file.name")}}: </strong>' + productArray[1].trim() + '</p><p><strong>{{trans("file.Code")}}: </strong>' + productArray[2].trim() + '</p><p><strong>{{trans("file.Brand")}}: </strong>' + productArray[3].trim() + '</p><p><strong>{{trans("file.category")}}: </strong>' + productArray[4].trim() + '</p><p><strong>{{trans("file.Quantity")}}: </strong>' + productArray[17].trim() + '</p><p><strong>{{trans("file.Unit")}}: </strong>' + productArray[5].trim() + '</p><p><strong>{{trans("file.Cost")}}: </strong>' + productArray[6].trim() + '</p><p><strong>{{trans("file.Price")}}: </strong>' + productArray[7].trim() + '</p><p><strong>{{trans("file.Tax")}}: </strong>' + productArray[8].trim() + '</p><p><strong>{{trans("file.Tax Method")}} : </strong>' + productArray[9].trim() + '</p><p><strong>{{trans("file.Alert Quantity")}} : </strong>' + productArray[10].trim() + '</p><p><strong>{{trans("file.Product Details")}}: </strong></p>' + productArray[11].trim();
